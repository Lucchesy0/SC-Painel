          ...
          <div className="relative flex-1">
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 p-1 cursor-pointer"
              >
                ✕
              </button>
            )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 max-h-[660px] overflow-y-auto touch-scroll custom-scrollbar p-1">
          {filteredEquipments.map((eq) => (
            ...
            >
              ...
              {/* Card Footer Actions */}
              <div
                className="px-2 py-1.5 border-t border-slate-200 dark:border-slate-700/80 bg-slate-50/70 dark:bg-slate-800/40 flex items-center justify-between"
                onClick={(e) => e.stopPropagation()}
              >
                <button
                  onClick={() => onOpenDetailModal(eq)}
                  className="px-2 py-1 rounded-md text-[11px] font-bold text-blue-600 dark:text-blue-400 hover:bg-blue-500/10 transition-colors flex items-center gap-1 cursor-pointer min-h-[28px]"
                >
                ...
                <div className="flex items-center gap-0.5">
                  <button
                    ...
                    className="p-1 rounded-md text-slate-400 hover:text-blue-600 hover:bg-blue-500/10 transition-colors cursor-pointer min-h-[28px] min-w-[28px] flex items-center justify-center"
                  >
                  ...
                  <button
                    ...
                    title="Excluir"
                    className="p-1 rounded-md text-slate-400 hover:text-rose-600 hover:bg-rose-500/10 transition-colors cursor-pointer min-h-[28px] min-w-[28px] flex items-center justify-center"
                  >
