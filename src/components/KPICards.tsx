...
export const KPICards: React.FC<KPICardsProps> = ({ scs }) => {
  ...
  return (
    <div className="flex flex-col gap-4 w-full max-w-full min-w-0">
      ...
      {/* Summary Alert Strip */}
      <section id="summaryStrip" className="flex flex-wrap items-center gap-2 sm:gap-3">
        {/* Pendências */}
        <div className="flex items-center gap-1.5 sm:gap-2 bg-amber-500/10 text-amber-700 dark:text-amber-300 px-3 py-1.5 rounded-full text-xs sm:text-sm font-medium border border-amber-500/20">
        ...
        {/* Atrasadas */}
        <div className="flex items-center gap-1.5 sm:gap-2 bg-red-500/10 text-red-700 dark:text-red-300 px-3 py-1.5 rounded-full text-xs sm:text-sm font-medium border border-red-500/20">
        ...
        {/* Mais antigas */}
        <div className="flex items-center gap-1.5 sm:gap-2 bg-white dark:bg-[#2a3040] text-slate-600 dark:text-slate-300 px-3 py-1.5 rounded-full text-xs sm:text-sm font-medium border border-slate-200 dark:border-slate-600/60 shadow-xs">
